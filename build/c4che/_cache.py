...
CFLAGS_PYEMBED = ['-march=nocona', '-mtune=haswell', '-ftree-vectorize', '-fPIC', '-fstack-protector-strong', '-fno-plt', '-flto', '-fuse-linker-plugin', '-ffat-lto-objects', '-fwrapv']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-march=nocona', '-mtune=haswell', '-ftree-vectorize', '-fPIC', '-fstack-protector-strong', '-fno-plt', '-flto', '-fuse-linker-plugin', '-ffat-lto-objects', '-fwrapv']
...
EXAMPLE_DIRECTORIES = ['tutorial', 'tcp', 'routing', 'error-model', 'matrix-topology', 'stats', 'naming', 'realtime', 'udp', 'ipv6', 'udp-client-server', 'socket', 'energy', 'traffic-control', 'wireless']
...
INCLUDES_PYEMBED = ['/home/xd/anaconda3/include/python3.6m']
INFODIR = '/usr/local/share/info'
INT64X64_USE_128 = 1
LIBDIR = '/usr/local/lib'
LIBEXECDIR = '/usr/local/libexec'
LIBPATH_BOOST = ['/usr/lib/x86_64-linux-gnu']
LIBPATH_PYEMBED = ['/home/xd/anaconda3/lib/python3.6/config-3.6m-x86_64-linux-gnu', '/home/xd/anaconda3/lib']
LIBPATH_ST = '-L%s'
...
LIB_LIBXML2 = ['xml2']
LIB_PYEMBED = ['python3.6m', 'pthread', 'dl', 'util', 'rt', 'm']
LIB_RT = ['rt']
LIB_SQLITE3 = ['sqlite3']
LIB_ST = '-l%s'
...
NS3_EXECUTABLE_PATH = ['/home/xd/ns-allinone-3.27/ns-3.27/build/src/fd-net-device', '/home/xd/ns-allinone-3.27/ns-3.27/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/5', '/home/xd/ns-allinone-3.27/ns-3.27/build']
...
cfg_files = ['/home/xd/ns-allinone-3.27/ns-3.27/build/ns3/config-store-config.h', '/home/xd/ns-allinone-3.27/ns-3.27/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
