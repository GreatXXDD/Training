           ...
           ++it)
        {
          ...
          if (it->second > 1)
          ...
          else
            {
              ...
              NS_LOG_INFO ("m_rapIdRntiMap store amount of rar"<<m_rapIdRntiMap.size());
            }
        }
  ...
  if (lcinfo.lcId != 0)
    {
      ...
      NS_LOG_FUNCTION ("m_logicalChannelIdentity" << +lccle.m_logicalChannelIdentity << "m_qci" << +lccle.m_qci);
